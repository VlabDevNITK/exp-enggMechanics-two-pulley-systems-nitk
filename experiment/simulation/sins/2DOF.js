...
if(f1 > 0)
{	
	ctx.moveTo(c.xcoord-10,c.ycoord-30);
	ctx.lineTo(c.xcoord+40,c.ycoord-30);
	ctx.lineTo(c.xcoord+33,c.ycoord-40);
	ctx.arcTo(c.xcoord+40,c.ycoord-30,c.xcoord+33,c.ycoord-20,25);
	ctx.lineTo(c.xcoord+40,c.ycoord-30);
	ctx.fill();
}
else
{
	ctx.moveTo(c.xcoord+40,c.ycoord-30);
	ctx.lineTo(c.xcoord-10,c.ycoord-30);
	ctx.lineTo(c.xcoord-3,c.ycoord-40);
	ctx.arcTo(c.xcoord-10,c.ycoord-30,c.xcoord-3,c.ycoord-20,25);
	ctx.lineTo(c.xcoord-10,c.ycoord-30);
	ctx.fill();
}
if(f2 > 0)
{
	ctx.moveTo(d.xcoord-10,c.ycoord-30);
	ctx.lineTo(d.xcoord+40,c.ycoord-30);
	ctx.lineTo(d.xcoord+33,c.ycoord-40);
	ctx.arcTo(d.xcoord+40,d.ycoord-30,d.xcoord+33,d.ycoord-20,25);
	ctx.lineTo(d.xcoord+40,c.ycoord-30);
	ctx.fill();
...
{
	ctx.moveTo(d.xcoord+40,c.ycoord-30);
	ctx.lineTo(d.xcoord-10,c.ycoord-30);
	ctx.lineTo(d.xcoord-3,c.ycoord-40);
	ctx.arcTo(d.xcoord-10,c.ycoord-30,d.xcoord-3,c.ycoord-20,25);
	ctx.lineTo(d.xcoord-10,c.ycoord-30);
	ctx.fill();
...
ctx.stroke();
   ...
   ctx.fillText("f1  "+Math.abs(parseFloat(f1.toFixed(4))), c.xcoord-40,c.ycoord-50);
   //ctx.restore();	context.save();
   ctx.lineWidth=1;
   ctx.font="12px 'Comic Sans MS'";
   ctx.fillStyle="#000000";
   ctx.fillText("f2  "+ Math.abs(parseFloat(f2.toFixed(4))),d.xcoord,d.ycoord-50);
   //ctx.restore();
	ctx.closePath();
